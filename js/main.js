jQuery(document).ready(function($){
	...
	function bouncy_filter(container) {
		container.each(function(){
			...
			let filter_list_container = pricing_table.children('.cd-pricing-switcher'),
			...
			filter_radios.on('change', function(event){
				...
				// $(this).parent().find('label[id=' + $(event.target).data('name') + ']').empty();
				//change the selected input to have the shadow
